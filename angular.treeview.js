...
(function ( angular ) {
    ...
    angular.module( 'angularTreeview', [] ).directive( 'treeModel', ['$compile', '$timeout',function( $compile, $timeout ) {
        return {
            restrict: 'A',
                ...
                if( treeId && treeModel ) {
                    ...
                    if( attrs.angularTreeview ) {
                        ...
                        scope[treeId].selectNodeLabel = scope[treeId].selectNodeLabel || function( selectedNode ){
                                ...
                                $timeout(function(){
                                    if (scope[clickFlag]){
                                        scope[treeId].dbClickFlag = false;
                                        scope[clickFlag] = false;
